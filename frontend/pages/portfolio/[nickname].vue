      ...
      <section class="flex items-start gap-5">
        ...
        <div class="flex-1 min-w-0">
          <div class="flex items-center gap-2 flex-wrap">
            <h1 class="text-xl font-bold text-foreground inline-flex items-center gap-1">
              <BadgeUserBadge :badge-type="portfolio.user.displayBadgeType" size="md" />
              {{ portfolio.user.name ?? portfolio.user.nickname }}
            </h1>
